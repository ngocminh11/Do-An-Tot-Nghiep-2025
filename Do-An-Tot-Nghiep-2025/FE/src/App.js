...
const CartManagement = lazy(() => import('./pages/admin/CartManagement/CartManagement'));
...
import './pages/admin/CommentManagement/CommentManagement.scss';
import './pages/admin/CartManagement/CartManagement.scss';
...
const AppContent = () => {
  ...
  const adminRoutes = [
    ...
    { path: '/admin/carts', element: <AdminLayout><CartManagement /></AdminLayout> },
  ];
